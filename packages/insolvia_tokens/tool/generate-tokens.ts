...
// banner toolchain-agnostic, and that is exactly what let this generator be
// re-implemented in another language — and let the output move between
// design-system packages — without rewriting a single generated byte.
const CSS_BANNER =
