...
output "api_lambda_alias_name" {
  description = "Production API Lambda alias serving traffic. The deploy workflow shifts it only after the freshly published version passes its smoke test."
...
output "marketing_ssr_alias_name" {
  description = "Production marketing SSR Lambda alias serving traffic. Shifted only after the freshly published version passes its smoke test."
